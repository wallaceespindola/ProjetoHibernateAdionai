...
function carregarPontos(pontos) {
	...
	limparMarcadores();
		...
		$.each(pontos, function(index, ponto) {
			...
			/* Verificar qual o tipo de marcardor de acordo com o tipo de serviÃ§o
			   C â€“ A caminho
			   E â€“ Em atendimento
			   A â€“ Atendimento Finalizado
			   P â€“ Atendimento Pendente
			*/
...
/*
{
        "tbAgendamento": {
            "IdOS": 1,
            "CdStatus": "c",
            "Servico": "Instalação Banda Larga 2M",
