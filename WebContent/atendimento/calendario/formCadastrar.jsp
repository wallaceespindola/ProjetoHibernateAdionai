				...
				<div class="panel-body">
					...
					<form id="formCadastrarAgendamento" action="/ProjetoHibernate/AtendimentoServlet.do" class="form-horizontal" role="form" form method="post">
						...
						<div class="col-sm-12">
							...
							<%= "<select name='slcCategoria' id='slcCategoria' class='form-control'>" +  DAOCategoria.gerarOptions() + "</select>" %>
						</div>

							<input type="hidden" name="Controle" value="CadastrarAgendamento" />
							
							<div class="text-right">
								<button type="submit" class="btn btn-success" id="Buscar"><span class="glyphicon glyphicon-floppy-save"></span> Cadastrar </button>
							</div>
							
							<p>hInicial: <input type="text" id="hInicial" name="hInicial" value="<%= hInicial %>"></p>
							<p>hFinal: <input type="text" id="hFinal" name="hFinal" value="<%= hFinal %>"></p>
							<p>Dia: <input type="text" id="dia" name="dia" value="<%= dia %>"></p>
							<p>Servico: <input type="text" id="idServico" name="idServico" value="<%= idServico %>"></p>
							<p>IdEquipe: <input type="text" id="idEquipe" name="idEquipe" value="<%= idEquipe %>"></p>
							<p>UsuarioLogadoId: <input type="text" id="usuarioLogado" name="usuarioLogado" value="<%= usuarioLogado %>"></p>
							<p>IdJanela: <input type="text" id="idJanela" name="idJanela" value="<%= idJanela %>"></p>
							<p>NrMatriculaTecnico: <input type="text" id="matriculaTecnico" name="matriculaTecnico" value="<%= matriculaTecnico %>"></p>
							<p>dt_agendamento: <input type="text" id="dt_agendamento" name="dt_agendamento" value="<%= dt_agendamento %>"></p>
