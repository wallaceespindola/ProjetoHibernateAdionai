...
public class ServicoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( (request.getParameter("Controle") != null) && 
			...
			servico = DAO.selectById(Integer.parseInt(request.getParameter("id")));
...
//				servico.setId_servico(Integer.parseInt(IdApagar));
//				servico.setNm_servico(nm_servico);
//				servico.setQt_inicio(Integer.parseInt(qt_inicio));
//				servico.setQt_fim(Integer.parseInt(qt_fim));
//				servico.setQtd_emp(Integer.parseInt(qtd_emp));
//				servico.setDt_vigencia(dt_vigencia);
				
				ServicoDAO DAO = new ServicoDAO();
				TbServico s = DAO.selectById(Integer.parseInt(IdApagar));

				String msg = DAO.apagarServico(s);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if( (request.getParameter("Controle") != null) && (request.getParameter("Controle").equals("Cadastrar")) ){
			...
			String msg = DAO.cadastrarServico(servico);
...
//			response.getWriter().write(resposta);
		...
		if( (request.getParameter("Controle") != null) && (request.getParameter("Controle").equals("Atualizar")) ){
			...
			if( !IdAtualizar.isEmpty() ){
		        ...
		        ServicoDAO DAO = new ServicoDAO();
				msg = DAO.atualizarServico(servico);
